    ...
    function ga(z, s) {
        ...
        function ha(b) {
            ...
            d.css({
                ...
                mouseover: function () {
                  ...
                  // var w= i.find(".click").children('img');
        ...
        function o(b) {
            i.find(".carousel-item").each(function (d) {
                ...
                e.css({
                    width: c.fn.carousel.defaults.width * r,
                    height: c.fn.carousel.defaults.height * r,
        ...
        function ia() {
            ...
            var e =
                c('<div class="scrollbar" style="display:none"></div>').appendTo(i),
        ...
        var i = c(z),
            ...
            U = 0,
            g = 0,
            Q = a.settings.width / 1.1,
            P = a.settings.height / 1.5,
