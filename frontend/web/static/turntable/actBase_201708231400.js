    ...
    1: [function (t, e, n) {
        ...
        !function (t) {
            var e = {
                getTuiaStyle: function (e) {
                    ...
                    var n;
                    n = window.navigator && window.navigator.connection && window.navigator.connection.type ? window.navigator.connection.type : null;
                    ...
                    e = t.extend(!0, {}, r, e), e.data.timestamp = i, window.xhr = t.ajax(e)
                    ...
                    if (window.performance) {
                        ...
                        if (n.loadEventEnd) {
                            var r = n.domComplete - n.domInteractive,
                                o = n.domContentLoadedEventEnd - n.navigationStart,
                                a = n.loadEventEnd - n.navigationStart,
                                s = window.dbStyleConfigEnd ? window.dbStyleConfigEnd - n.navigationStart : "",
                                c = window.dbStyleConfigEnd - window.dbStyleConfigStart,
                                u = "/statistics/activityPagePerf?hdType=" + actType + "&oaId=" + CFG.activityId + "&domComplete=" + r + "&domLoaded=" + o + "&onload=" + a + "&white=" + s + "&dbStyle=" + c,
                                l = (new Date).getTime(), f = {
                                    url: u, type: "post", data: {}, dataType: "json", success: function () {
                                    }, error: function () {
                                    }
                                };
        ...
        var i = "function" == typeof Symbol && "symbol" === _typeof2(Symbol.iterator) ? function (t) {
            ...
            var E, C, S, k, T, j, N = [], A = N.slice, O = N.filter, L = window.document, P = {}, I = {}, _ = {
                ...
                R = /([A-Z])/g, $ = ["val", "css", "html", "text", "data", "width", "height", "offset"],
                ...
                U = {
                    ...
                    th: Z,
                    "*": L.createElement("div")
                }, W = /complete|loaded|interactive/, X = /^[\w-]*$/, H = {}, G = H.toString, V = {},
                J = L.createElement("div"), Y = {
                    tabindex: "tabIndex",
                    readonly: "readOnly",
                    "for": "htmlFor",
                    "class": "className",
            ...
            return V.matches = function (t, e) {
                ...
                var i, r, o;
                return F.test(t) && (i = S(L.createElement(RegExp.$1))), i || (t.replace && (t = t.replace(M, "<$1></$2>")), e === E && (e = D.test(t) && RegExp.$1), e in U || (e = "*"), o = U[e], o.innerHTML = "" + t, i = S.each(A.call(o.childNodes), function () {
                    o.removeChild(this)
