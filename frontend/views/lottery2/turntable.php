...
<head>
    ...
    <style>
        ...
        #db-content {
            background-image: url(/static/turntable2/736eh4253m.png) !important;
        }
        ...
        .record {
            background-image: url(/static/turntable2/051z8lznit.png) !important;
        }
...
<div id="db-content" style="display: block;">
    <a class="record" href="<?= Url::to('lottery2/list') ?>"></a>
    <div class="banner">
        <img class="theme" src="/static/turntable2/idqmckrkeq.png">
        <div class="rule"></div>
    </div>
...
//        var testkey = <?php //echo $testkey ?>//;
    ...
    function fun_sx() {
//        window.location.href="<?php // echo Yii::app()->createUrl('lottery/turntable2') ?>//";
//        if (number <= 5){
//            $("#test").css("display", "block");
//        }
        window.location.href="<?= Url::to(['lottery2/turntable']) ?>";
    }
</script>
...
<div style="display:none;">
    <script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1264339820'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s13.cnzz.com/z_stat.php%3Fid%3D1264340266%26show%3Dpic' type='text/javascript'%3E%3C/script%3E"));</script>
</div>
